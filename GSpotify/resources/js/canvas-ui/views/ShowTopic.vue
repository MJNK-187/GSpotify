<template>
    <section  style="background-color: #313131   ; height:100vh; ">
        <page-header />

        <div v-if="isReady" class="mt-5">
            <div class="col-xl-8 offset-xl-2 col-lg-10 offset-lg-1 col-md-12 mt-3">
                <h3 class="my-0 text-white">Album: {{ topic.name }}</h3>
                <p class="text-secondary">Toegevoegd: {{ moment(topic.created_at).fromNow() }}</p>

                <main role="main" class="mt-5">
                    <div>
                        <h4 class="my-4 border-bottom mt-5 pb-2">
                            <span class="border-bottom border-success text-white pb-2">Nummer</span>
                        </h4>
