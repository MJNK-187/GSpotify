    ...
    <section  style="background-color: #313131   ; height:100vh; ">
        ...
        <div v-if="isReady" class="mt-5">
            <div class="col-xl-8 offset-xl-2 col-lg-10 offset-lg-1 col-md-12 mt-3">
                <h1 class="font-serif" style="color:#1DB954">{{ post.title }}</h1>
                ...
                <div class="post-content position-relative align-items-center overflow-y-visible font-serif mt-4 text-white">
